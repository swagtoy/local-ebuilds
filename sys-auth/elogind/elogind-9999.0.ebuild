...
PATCHES=(
	...
	#"${FILESDIR}/${PN}-255.5-part-revert-header-cleanup.patch" # bug 939673
	# See also:
	# https://github.com/elogind/elogind/issues/285
	#"${FILESDIR}/${PN}-255.5-revert-s2idle.patch" # bug 939042
	# See also: https://github.com/systemd/systemd/issues/10103
	#"${FILESDIR}/${PN}-255.5-no-fchmod_and_chown-tty.patch" # thx to Devuan
)
